...
public static class PageMapping
{
    ...
    public static List<PostSelectViewModel> MapSelectPostViewModel ( List<PostDataModel> listSelectProductsDataModels,EnumTenantStore categoryFor,EnumCurrency currency )
    {
