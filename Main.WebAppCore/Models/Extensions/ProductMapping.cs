...
public static class ProductMapping
{
    ...
    public static ProductViewModel MapProductViewModel ( ProductDataModel productDataModel,EnumTenantStore enumShopType )
    {
    ...
    public static List<ProductDisplayViewModel> MapDisplayProductViewModel ( List<ProductDisplayModel> productDataModels,EnumTenantStore EnumShopType )
    {
